...
<script>
    $(function () {
        $("input[name='username']").blur(function () {
            ...
            $.ajax({
				url:"${pageContext.request.contextPath}/AjaxServlet?op=checkUsername",
...
<body>
<div class="container">
	<form class="form-horizontal" id="myform" action="${pageContext.request.contextPath}/UserServlet?op=register" method="post">
		...
		<div class="form-group">
            ...
            <label for="stuName" class="col-sm-2  control-label" style="margin-left: -60px" id="usernameInfo"></label>
		</div>
